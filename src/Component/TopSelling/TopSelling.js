    ...
    <div className="topSelling">
      <div className="topSelling__top">
        ...
        <div className="topSelling_catagories">
          <button onClick={()=>handleActive("mobile")} className={active.mobile && "active_btn"}>Mobile</button>
          <button onClick={()=>handleActive("laptop")} className={active.laptop && "active_btn"} >Laptop</button>
          <button onClick={()=>handleActive("camera")} className={active.camera ? "active_btn diff" : "diff"} >Camera</button>
        </div>
        {/* mobile */}
        {
          active.mobile && <div className="topBrand">
              <div>
              ...
              <div>
                  <div>
                    ...
                    <div className="topBrand__caption">
                        <h4>Apple Iphone <AppleIcon></AppleIcon> </h4>
                        <small>Lorem ipsum dolor sit amet </small>
                        <button className="shopNow__btn">Shop now</button>
                    </div>
                  </div>
        ...
        {/* laptop */}
        {
          active.laptop && <div className="topBrand">
              <div>
